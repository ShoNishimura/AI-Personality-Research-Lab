...
| [PF-EXP-0004](PF-EXP-0004-history-conditioned-response/) | **planned / protocol and gates frozen before responses** | 同一Perceptionのもとで、過去の結果履歴は現在のResponseを再現可能に変えるか |
...
PF-EXP-0004はResponse側へ進む最初の実験として、`R_t=g(P_t,H_t,Rel_t)` のうち **History → Response** を単独で検証する。Perceptionを固定し、Relationshipをneutral / noneに固定して、類似状況における過去Responseの結果履歴だけを操作する。
