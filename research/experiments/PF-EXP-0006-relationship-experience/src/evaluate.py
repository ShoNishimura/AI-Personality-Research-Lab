...
def evaluate_row(client: Any, config: dict[str, Any], row: dict[str, Any], schema: dict[str, Any]) -> dict[str, Any]:
    ...
    response = client.responses.create(
        ...
        store=False,
        text={"format": {"type": "json_schema", "name": "aprl_pf_exp_0006_evaluation", "strict": True, "schema": schema}},
    )
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Blind-evaluate PF-EXP-0006 Experiences.")
