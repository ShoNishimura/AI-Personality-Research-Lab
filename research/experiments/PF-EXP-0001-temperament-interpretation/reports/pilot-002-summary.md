...
G4の未達要因を診断するため、Gate判定後にConflict × T11をscoreだけでunblindした。Interpretation本文は読んでいない。
...
Additive prediction from T00/T01/T10 would place T11 near `(3.0, 2.5)`, while observed T11 was `(2.5, 1.5)`.
...
It motivates the next independent pilot:

> [PF-EXP-0002 — Opportunity × Danger Interaction](../../PF-EXP-0002-opportunity-danger-interaction/)

PF-EXP-0002 tests whether increasing Opportunity Value attenuates Danger Salience more strongly under High Seeking Reactivity, using six new scenario families and no reuse of `ST-C-01`.
